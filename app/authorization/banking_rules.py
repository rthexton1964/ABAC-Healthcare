...
def create_healthcare_abac_rules():
    ...
    def senior_access(req: AuthorizationRequest) -> bool:
        return (
            ...
            req.action in {"view_record", "edit_record", "prescribe", "order_test"}
        )
    ...
    def cross_location_deny(req: AuthorizationRequest) -> bool:
        return (
            req.user.attributes.role == 'doctor' and
    ...
    def junior_restriction(req: AuthorizationRequest) -> bool:
        return req.user.attributes.level == 'junior' and req.action in {"prescribe", "order_test"}
...
def create_all_rules():
    ...
    return create_healthcare_abac_rules()
