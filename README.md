# Healthcare ABAC Application

Hospital management system with fine-grained ABAC authorization

## Features

- Fine-grained ABAC authorization
- Multiple user roles: Doctors, Nurses, Administrators, Patients, Pharmacists
- Resource management: Medical Records, Prescriptions, Lab Results, Appointments
